...
public class ReaderController {
    ...
    public String readerDelete(HttpServletRequest request,RedirectAttributes redirectAttributes){
        ...
        boolean judgeNotReturn=lendService.myLendListNotReturn(readerId);
        if(judgeNotReturn){
            redirectAttributes.addFlashAttribute("error", "删除失败！该读者还有未归还的书");
            return "redirect:/allreaders.html";
        }
        boolean success1=readerInfoService.deleteReaderInfo(readerId);
        boolean success2=readerCardService.deleteReaderInfo(readerId);
    ...
    public String readerInfoAddDo(String name,String passwd,String sex,String birth,String address,String telcode,int readerId,RedirectAttributes redirectAttributes){
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd");
        Date nbirth=new Date();
        try{
            java.util.Date date=sdf.parse(birth);
