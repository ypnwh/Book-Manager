...
public class ReaderCardDao {
    ...
    private final static String ADD_READERCARD_SQL="INSERT INTO reader_card (reader_id,name,passwd) values ( ? , ? , ?)";
    ...
    public int addReaderCard(ReaderCard readerCard){
        ...
        return jdbcTemplate.update(ADD_READERCARD_SQL,new Object[]{readerId,name,passwd});
    }
